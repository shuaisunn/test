...
function indcpaDecrypt(c, privateKey) {
    ...
    // extract ciphertext
    var u = decompress1(c.slice(0, 640));
    var v = decompress2(c.slice(640, 768));
...
Test512 = function(){
    ...
    var fs = require('fs');
    var textByLine = fs.readFileSync('./node_modules/crystals-kyber/PQCkemKAT_1632.rsp').toString().split("\n");
